...
const ONBOARDING_MARKETPLACE_APPS: OnboardingApp[] = [
  // HR Apps
  {
    ...
    iconText: "AD",
    description:
      "Sync payroll taxes, hours tracking, and direct disbursements.",
    logoBg: "bg-red-600",
  ...
  },
  {
    ...
    iconText: "WD",
    description:
      "Manage corporate directory catalogs and user access permissions.",
    logoBg: "bg-blue-600",
    logoColor: "text-white",
    associatedSidebar: "hr",
  },
  ...
  },
  {
    ...
    iconText: "XE",
    description:
      "Double-entry opex registries and currency exchange rate syncing.",
    logoBg: "bg-teal-600",
    logoColor: "text-white",
    associatedSidebar: "financials",
  },
  ...
  },
  {
    ...
    iconText: "FP",
    description:
      "Coordinate maritime shipping manifests and custom clearances.",
    logoBg: "bg-slate-950",
    logoColor: "text-white",
    associatedSidebar: "supply-chain",
  },
...
const GENERAL_ONBOARDING_APPS: OnboardingApp[] = [
  {
    ...
    iconText: "SQ",
    description:
      "Integrate default store terminals and localized card machines.",
    logoBg: "bg-black",
    logoColor: "text-white",
  ...
  },
  {
    ...
    iconText: "XL",
    description:
      "Sync transactional spreadsheets, budget models, and load analytical workbooks from OneDrive.",
  ...
  },
  {
    ...
    iconText: "GC",
    description:
      "Analyze BigQuery data sets, Kubernetes, and machine learning endpoints.",
    logoBg: "bg-emerald-600",
    logoColor: "text-white",
    associatedSidebar: "general",
  },
  {
    ...
    iconText: "SL",
    description:
      "Integrate enterprise Slack workspaces, automated alerts, and channels.",
    logoBg: "bg-purple-600",
    logoColor: "text-white",
    associatedSidebar: "general",
  },
  {
    ...
    iconText: "GW",
    description:
      "Authorize Calendar scheduling, team Docs, and Gmail triggers.",
...
export function OnboardingSetup({
  ...
  const [selectedSidebarOptions, setSelectedSidebarOptions] = useState<
    string[]
  >(["hr", "marketing", "financials"]);

  // Connected apps (keep track of live statuses)
  const [tempConnectedApps, setTempConnectedApps] = useState<string[]>([
    "square",
  ]);
  ...
  const [appCredentials, setAppCredentials] = useState<
    Record<string, { handle: string; token: string }>
  >({
  ...
  const OPTIONAL_MODULES = [
    {
      ...
      description:
        "Manage staff directories, view KPI ratios, leave tracking, and create rosters.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Draft promotion strategies with AI advice, track campaigns, and edit calendars.",
      icon: Megaphone,
      badge: "Campaigns",
    },
    {
      ...
      description:
        "Review double-entry ledgers, income balances, and secure cash schedules.",
      icon: LineChartIcon,
      badge: "Secure Access",
    },
    {
      ...
      label: "Supply Chain",
      description:
        "Monitor multi-tenant supply loops, shipping freights, and restock parameters.",
      icon: Package,
      badge: "Replenishment",
    },
    {
      ...
      description:
        "Track inventory indexes, customer checkout counts, and sales velocity charts.",
      icon: ShoppingBag,
      badge: "Inventory",
    },
  ];
  ...
  const handleToggleSidebarOption = (optionId: string) => {
    if (selectedSidebarOptions.includes(optionId)) {
      setSelectedSidebarOptions(
        selectedSidebarOptions.filter((id) => id !== optionId),
      );
    } else {
  ...
  const handleAuthorizeApp = async (appId: string) => {
    if (!appCredentialHandle.trim() || !appCredentialToken.trim()) {
      alert(
        "Please enter the required account setup credentials to synchronize this app.",
      );
      return;
    }
  ...
  return (
    <div
      className={`min-h-screen ${styles.canvas} flex flex-col justify-center items-center p-4 selection:bg-[#D4FC34]/40 select-none transition-colors duration-300 relative`}
    >
      ...
      {onSetPreset && (
        <div className="absolute top-6 right-6 flex items-center gap-2 z-20">
            ...
            className={`text-[10px] font-sans font-bold pr-8 pl-3 py-1.5 rounded-lg border focus:outline-none cursor-pointer appearance-none ${
              preset === "stark"
                ...
                : preset === "cosmic"
                  ...
                  : preset === "mist"
                    ? "bg-white border-[#DDE3EE] text-[#1E293B] hover:bg-[#F1F5F9]"
          ...
          >
            ...
            <option value="mist">🎨 Theme: Mist Light</option>
          </select>
        </div>
      )}
      ...
      <div
        className={`max-w-3xl w-full ${styles.card} overflow-hidden text-left flex flex-col animate-in fade-in duration-300`}
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-semibold tracking-wide">
                Configure personalized enterprise divisions and accounts
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {[1, 2, 3].map((stepNum) => (
              <div key={stepNum} className="flex items-center">
                ...
                {stepNum < 3 && (
                  <div
                    className={`w-6 h-0.5 ${currentStep > stepNum ? "bg-emerald-600" : "bg-slate-800"}`}
                  />
                )}
              </div>
            ))}
        ...
        <div className="p-8 flex-1 min-h-[380px]">
          ...
          {currentStep === 1 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="text-left">
                <h2
                  className={`text-xl font-bold tracking-tight ${preset === "cosmic" ? "text-white" : "text-slate-800"}`}
                >
                  Tell us about your Company
                </h2>
                <p
                  className={`text-xs mt-1 ${preset === "cosmic" ? "text-slate-400" : "text-slate-500 font-semibold mt-1"}`}
                >
                  We customize the analytical defaults, reporting layouts, and
                  location metrics based on these variables.
                </p>
              </div>
              ...
              <div className="space-y-4 max-w-xl">
                ...
                <div className="space-y-1.5">
                  <label
                    htmlFor="setup-biz-name"
                    className={`text-[10px] font-bold uppercase tracking-wider block ${preset === "cosmic" ? "text-slate-400" : "text-slate-500"}`}
                  >
              ...
              {/* Tips Section */}
              <div
                className={`p-4 border leading-relaxed text-xs font-semibold max-w-xl ${
                  preset === "stark"
              ...
              >
                <span
                  className={`block font-bold uppercase tracking-widest text-[9px] mb-1 ${
                    preset === "cosmic"
                      ? "text-violet-400"
                      : preset === "stark"
                        ? "text-slate-900"
                ...
                You can fully synchronize multiple outlets, register desks, or
                store coordinates later in settings. This configures your
                initial default terminal.
              </div>
            </div>
          )}
          ...
          {currentStep === 2 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div>
                <h2
                  className={`text-xl font-bold tracking-tight ${preset === "cosmic" ? "text-white" : "text-slate-805 text-slate-800"}`}
                >
                  Select Sidebar Divisions
                </h2>
                <p
                  className={`text-xs mt-1 ${preset === "cosmic" ? "text-slate-400" : "text-slate-500 mt-1"}`}
                >
                  Customize your workspace modules. Choose which custom screens
                  you want present on your main sidebar menu.
                </p>
              </div>

              {/* Preselected list notification */}
              <div
                className={`flex flex-wrap items-center gap-2 p-3.5 border text-xs font-medium ${
                  preset === "stark"
              ...
              >
                <span
                  className={`font-bold ${preset === "cosmic" ? "text-slate-200" : "text-slate-705"}`}
                >
                  Pre-enabled Core Sections:
                </span>
                <span
                  className={`border rounded px-1.5 py-0.5 text-[10px] font-bold flex items-center gap-1 ${
                    preset === "cosmic"
                      ? "bg-[#1E293B] border-slate-700 text-violet-400"
                      : "bg-white border text-emerald-600"
                  }`}
                >
                ...
                <span className="text-[10px] font-bold text-slate-400 tracking-widest uppercase ml-auto">
                  always present
                </span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div>
                            ...
                            className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                              isChecked
                                ...
                                : preset === "cosmic"
                                  ...
                                  : "bg-slate-100 text-slate-505 text-slate-500"
                            }`}
                          >
                            ...
                            className={`w-4 h-4 rounded-full border flex items-center justify-center transition-all ${
                              isChecked
                                ? preset === "cosmic"
                                  ...
                                  : "bg-[#008060] border-emerald-600 text-white"
                                : preset === "cosmic"
                                  ? "border-slate-705"
                                  : "border-slate-300"
                            }`}
                        ...
                        <h4
                          className={`font-bold text-xs tracking-tight ${preset === "cosmic" ? "text-slate-100" : "text-slate-805"}`}
                        >
                          {module.label}
                        </h4>
                        <p
                          className={`text-[10.5px] leading-normal mt-1 font-semibold ${preset === "cosmic" ? "text-slate-400" : "text-slate-500"}`}
                        >
                          {module.description}
                        </p>
                      </div>
                      ...
                      <div className="mt-4 flex">
                        <span
                          className={`text-[8.5px] font-black uppercase tracking-wider px-2 py-0.5 rounded ${
                            isChecked
                              ? preset === "cosmic"
          ...
          {currentStep === 3 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div>
                ...
                <p
                  className={`text-xs mt-1 ${preset === "cosmic" ? "text-slate-400" : "text-slate-500 font-semibold"}`}
                >
                  Authorize direct synchronization feeds for chosen enterprise
                  modules. You can skip or toggle connections anytime.
                </p>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        {renderAppLogo(
                          app.id,
                          "w-10 h-10 rounded-lg flex items-center justify-center shrink-0 text-sm shadow-sm border border-slate-200/50 bg-white overflow-hidden",
                        )}

                        <div className="space-y-1 text-left flex-1 select-text">
                          <div className="flex items-center justify-between pr-12">
                            <h4
                              className={`font-bold text-xs flex items-center gap-1 ${preset === "cosmic" ? "text-slate-100" : "text-slate-800"}`}
                            >
                              {app.name}
                            </h4>
                          </div>
                          <p
                            className={`text-[10px] pr-2 ${preset === "cosmic" ? "text-slate-400" : "text-slate-500 font-semibold"} leading-snug`}
                          >
                            {app.description}
                          </p>
                        </div>
                      ...
                      {isConfiguring ? (
                        <div
                          className={`p-3 rounded-xl border text-left space-y-2 animate-in slide-in-from-top-1 duration-200 ${
                            preset === "cosmic"
                        ...
                        >
                          <p
                            className={`font-black text-[8.5px] uppercase tracking-wider ${preset === "cosmic" ? "text-violet-400" : "text-slate-700"}`}
                          >
                            🔒 SETUP SECURE CREDENTIAL FEED
                          </p>
                          <div className="space-y-1">
                            <label
                              className={`block text-[8px] font-bold uppercase ${preset === "cosmic" ? "text-slate-400" : "text-slate-500"}`}
                            >
                          ...
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setAppCredentialToken(e.target.value)
                              }
                              placeholder="••••••••••••••••"
                              className={`w-full text-xs p-1.5 border rounded-lg outline-none focus:border-indigo-500 ${
                                preset === "cosmic"
                        ...
                        <div className="mt-1 flex items-center justify-between text-[10px] text-slate-500 border-t pt-2 border-slate-100 select-text">
                          <div className="font-semibold text-[9.5px]">
                            Synced:{" "}
                            <span className="font-mono text-emerald-600 font-bold bg-emerald-50 px-1 py-0.2 rounded border border-emerald-100">
                              {appCredentials[app.id]?.handle ||
                                "square_terminal_7"}
                            </span>
                          </div>
                          <button
                      ...
                      <div className="absolute top-2 right-2 flex items-center justify-end">
                        <span
                          className={`text-[7px] font-bold px-1 py-0.2 rounded uppercase border shrink-0 ${
                            preset === "cosmic"
              ...
              {visibleAppsToConnect.length === 0 && (
                ...
                >
                  <p className="text-xs font-semibold">
                    No integration categories requested. Click Complete below to
                    initiate clean workspace.
                  </p>
                </div>
              )}
            </div>
        ...
        <div
          className={`px-8 py-5 border-t flex items-center justify-between ${
            preset === "stark"
              ? "bg-[#F8FAFC] border-slate-150"
              : preset === "cosmic"
                ? "bg-[#111215] border-[#27272A]"
        ...
        >
          ...
          {currentStep < 3 ? (
            <button
              ...
              disabled={
                currentStep === 1 && (!businessName.trim() || !location.trim())
              }
